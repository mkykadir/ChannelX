...
public class TrulyFilledFieldsShouldSignUpUser {
  ...
  @Test
  public void testTrulyFilledFieldsShouldSignUpUser() throws Exception {
    ...
    assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Thanks for registering, we've sent email for validation[\\s\\S]*$"));
  }
